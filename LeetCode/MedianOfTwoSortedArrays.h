...
First find the medians of the two sorted arrays respectively named med1 and med2. Then I compare these two numbers, WLOG,
I presume that med1 > med2. Then any number following med1 in nums1 and ahead of med2 in nums2 is not possible to be the
median of the two arrays. I compare the lengths of these two half arrays and store the shorter one in variable cutLen. The
